...
$lang = array_merge($lang, [
	...
	'DMP_IMG_DESC'			=> 'Enter here the URL to your site logo (<strong>incl. http://</strong>).<br>The URL may not exceed the max number of 255 characters!<br />The image width should not be more than 400px.',
	'DMP_NEED'				=> 'Fields with a (*) needs to be filled!',
	'DMP_BG_IMG'			=> 'Bg_header.gif of your partner',
	'DMP_BG_IMG_DESC'		=> 'Enter here the URL of the Bg_header.gif image of your partner (<strong>incl. http://</strong>)',
	'DMP_NEED_DATA'			=> 'You need to enter an <strong>URL</strong> and a <strong>title</strong> and <strong>description</strong>, if you like to add your site.',
	...
	'DMP_URL_DESC'			=> 'Please enter the URL to your site (<strong>incl. http://</strong>).<br>The URL may not exceed the max number of 255 characters!',
